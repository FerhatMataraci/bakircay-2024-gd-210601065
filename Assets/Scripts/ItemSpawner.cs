...
namespace Match
{
    public class ItemSpawner : MonoBehaviour
    {
        ...
        private void Update()
        {
            // T�m objeler e�le�ti�inde yeni level ba�lat
        ...
        /// <summary>
        /// Aktif olan t�m itemlar� d�nd�r�r
        /// </summary>
        ...
        /// <summary>
        /// Hint sistemi i�in rastgele bir �ift e�le�en item d�nd�r�r
        /// </summary>
        public (Item, Item) GetRandomMatchingPair()
        {
            var activeItems = GetItems();

            // E�le�en item gruplar�n� bul
            var matchGroups = activeItems
                .GroupBy(x => x.matchID)
                .Where(g => g.Count() >= 2) // En az 2 aktif item olan gruplar� al
                .ToList();

            if (matchGroups.Count == 0)
                return (null, null);

            // Rastgele bir grup (t�r) se�
        ...
        /// <summary>
        /// Hint yetene�i i�in z�plama animasyonunu y�netir
        /// </summary>
        ...
        public void SpawnObjects()
        {
            ...
            // Repository'den rastgele itemlar� al
        ...
        /// <summary>
        /// Spawn edilmi� t�m objeleri temizler
        /// </summary>
        ...
        /// <summary>
        /// Ge�erli bir spawn pozisyonu bulur
        /// </summary>
        private Vector3 GetValidSpawnPosition()
        {
            ...
            do
            {
                ...
                // Pozisyonun di�er objelerle mesafesini kontrol et
        ...
        /// <summary>
        /// Spawn alan� i�inde rastgele bir pozisyon d�nd�r�r
        /// </summary>
